...
function isOverContainer(container, x, y) {
  return (
    !container ||
    (0, _contains2.default)(container, document.elementFromPoint(x, y))
  )
}
...
var Selection = (function() {
  function Selection(node) {
    var _ref2 =
      ...
      longPressThreshold =
        _ref2$longPressThresh === undefined ? 250 : _ref2$longPressThresh
  ...
  Selection.prototype._addLongPressListener = function _addLongPressListener(
    handler,
    initialEvent
  ) {
    var _this = this
  ...
  Selection.prototype._handleTerminatingEvent = function _handleTerminatingEvent(
    e
  ) {
    ...
    var inRoot =
      !this.container || (0, _contains2.default)(this.container(), e.target)
...
function normalizeDistance() {
  ...
  if (
    (typeof distance === 'undefined' ? 'undefined' : _typeof(distance)) !==
    'object'
  )
    distance = {
      top: distance,
...
function objectsCollide(nodeA, nodeB) {
  ...
  var _getBoundsForNode = getBoundsForNode(nodeA),
    ...
    aRight =
      _getBoundsForNode$rig === undefined ? aLeft : _getBoundsForNode$rig,
  ...
  var _getBoundsForNode2 = getBoundsForNode(nodeB),
    ...
    bRight =
      _getBoundsForNode2$ri === undefined ? bLeft : _getBoundsForNode2$ri,
